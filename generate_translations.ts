...
const hi = {
  ...
  'stage.initiateSequence': 'अनुक्रम आरंभ करें', 'stage.termsOfEngagement': 'सगाई की शर्तें', 'stage.termsMessage': 'आगे बढ़कर, आप अधिकतम भार उठाने से जुड़े शारीरिक जोखिमों को स्वीकार करते हैं। Vanguard सीएनएस थकान, मस्कुलोस्केलेटल क्षति, या अहंकार को चोट पहुंचाने के लिए कोई दायित्व नहीं लेता है।', 'stage.iAccept': 'मैं जोखिम स्वीकार करता हूं', 'stage.cancel': 'रद्द करें',
