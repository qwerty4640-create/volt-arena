...
const zh = {
  ...
  'stage.initiateSequence': '启动序列', 'stage.termsOfEngagement': '交战条款', 'stage.termsMessage': '继续操作即表示您承认与最大负荷举重相关的物理风险。Volt Arena对中枢神经系统疲劳、肌肉骨骼损伤或自尊心受挫不承担任何责任。', 'stage.iAccept': '我接受风险', 'stage.cancel': '取消',
...
const ko = {
  ...
  'stage.initiateSequence': '시퀀스 시작', 'stage.termsOfEngagement': '참여 조건', 'stage.termsMessage': '계속 진행하면 최대 하중 리프팅과 관련된 신체적 위험을 인정하는 것입니다. Volt Arena는 CNS 피로, 근골격계 손상 또는 자존심 상처에 대해 책임을 지지 않습니다.', 'stage.iAccept': '위험을 수락합니다', 'stage.cancel': '취소',
...
const ja = {
  ...
  'stage.initiateSequence': 'シーケンス開始', 'stage.termsOfEngagement': '参加条件', 'stage.termsMessage': '続行することにより、最大負荷の持ち上げに関連する身体的リスクを認識したことになります。Volt Arenaは、CNSの疲労、筋骨格の損傷、または自尊心の傷について一切の責任を負いません。', 'stage.iAccept': 'リスクを受け入れます', 'stage.cancel': 'キャンセル',
...
const es = {
  ...
  'stage.initiateSequence': 'Iniciar Secuencia', 'stage.termsOfEngagement': 'Términos de Compromiso', 'stage.termsMessage': 'Al proceder, reconoces los riesgos físicos asociados con el levantamiento de carga máxima. Volt Arena no asume ninguna responsabilidad por fatiga del SNC, daño musculoesquelético o moretones en el ego.', 'stage.iAccept': 'Acepto los Riesgos', 'stage.cancel': 'Cancelar',
...
const nl = {
  ...
  'stage.initiateSequence': 'Start Reeks', 'stage.termsOfEngagement': 'Voorwaarden van Betrokkenheid', 'stage.termsMessage': 'Door door te gaan, erkent u de fysieke risico\'s die gepaard gaan met het tillen van maximale belastingen. Volt Arena aanvaardt geen aansprakelijkheid voor CZS-vermoeidheid, musculoskeletale schade of gekneusde ego\'s.', 'stage.iAccept': 'Ik Accepteer de Risico\'s', 'stage.cancel': 'Annuleren',
