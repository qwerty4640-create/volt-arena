    ...
    <div className="flex flex-col min-h-full w-full max-w-7xl mx-auto px-4 pt-12 md:pt-16 pb-20">
      <header className="mb-12">
        ...
        <div className="flex flex-col mb-2">
          ...
          <h1 className="font-headline text-2xl md:text-3xl font-semibold uppercase tracking-widest text-white">
            {viewState.level === 'blocks' && <>Current Strategy</>}
            {viewState.level === 'phases' && <>Operational Phases</>}
            {viewState.level === 'missions' && <>Mission Deployment</>}
          </h1>
        </div>
