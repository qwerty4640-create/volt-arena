    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <div className="flex flex-col items-start gap-1">
            ...
            {blocks.length > 0 && <span className="text-[8px] tracking-widest uppercase text-white/50">DRAG AND DROP TO REARRANGE</span>}
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4 lg:col-span-3">
          <div className="flex flex-col items-start gap-1">
            ...
            <span className="text-[8px] tracking-widest text-zinc-500 uppercase">CLICK TO APPEND</span>
          </div>
      ...
      {advisories.length > 0 ? (
        ...
        >
            ...
            <div>
                <p className="text-[11px] font-black uppercase tracking-[0.15em] text-[#06d6a0]">SEQUENCE INTEGRITY: OPTIMAL</p>
                <p className="text-[9px] font-black uppercase tracking-[0.1em] text-zinc-500 mt-1 leading-relaxed max-w-lg">
