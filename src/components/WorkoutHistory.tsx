                      ...
                      <div className="space-y-2">
                        ...
                        {isWorkout ? (
                          <div className="flex gap-2 items-center">
                            <span className="text-[8px] font-black uppercase tracking-widest px-2 py-1 bg-volt/10 text-volt border-none">
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            className="w-8 h-8 btn-destructive flex items-center justify-center bg-white/5"
                          >
                            <Trash2 size={16} />
                          </button>
                        </div>
            ...
            <AnimatePresence mode="wait">
              {selectedWorkout ? (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 20 }}
                  className="glass-panel p-4 md:p-8 border-none h-full flex flex-col gap-6 md:gap-8 relative overflow-hidden"
                >
                  {/* Background Glow */}
                    ...
                    <div className="flex gap-2">
                      {selectedWorkout.logType === 'workout' && (
                        <button
                          ...
                          className="btn-primary w-8 h-8 flex items-center justify-center text-zinc-600 hover:text-volt transition-colors"
                        >
                          <Edit2 size={16} />
                        </button>
                      )}
                      <button
                        ...
                        className="btn-destructive w-8 h-8 bg-white/5 flex items-center justify-center"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
        ...
        <AnimatePresence>
          {isEditing && editWorkout && (
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:p-8">
              ...
              >
                {/* Modal Header */}
                <div className="p-4 md:p-8 flex items-center justify-between bg-surface-container-high">
                  <div className="flex items-center gap-4">
