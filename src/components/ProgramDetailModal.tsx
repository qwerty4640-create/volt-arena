        ...
        {isOpen && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            >
                    ...
                    <div className="space-y-4">
                      {Array.isArray(plan) && plan.map((block, idx) => (
                        ...
                        >
                          ...
                          {*/}
                          <div className={cn(
                            "glass-panel p-4 bg-surface-container-lowest border-white/5 flex flex-col md:flex-row items-left gap-4",
              ...
              {/* Footer */}
              <div className="p-4 border-t border-white/5 bg-void/50 flex justify-end">
                <button
                  onClick={onClose}
                  className="btn-secondary px-12 py-3 w-full uppercase"
                >
                  close
                </button>
              </div>
