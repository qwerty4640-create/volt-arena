...
export const EXERCISE_DATABASE: ExerciseDefinition[] = [
  ...
  { id: 'archer_pushups', name: 'Archer Pushups', category: 'Bench', pattern: 'push_horizontal', impact: 'low', velocity: 'medium', isUnilateral: true, description: 'Challenging pushup variation loading one side more.', instructions: ['Pushup position.', 'Shift to one side.', 'Push up.', 'Repeat.'], tips: ['Keep core braced.', 'Control movement.', 'Full extension.'], muscles: ['Chest', 'Triceps', 'Core'] },
  ...
  // Biceps Category
  { id: 'db_bicep_curl', name: 'Dumbbell Bicep Curl', category: 'Biceps', pattern: 'accessory', impact: 'low', velocity: 'medium', description: 'Isolation curl for biceps.', instructions: ['Hold dumbbells.', 'Curl up.', 'Lower controlled.'], tips: ['Avoid momentum.', 'Full range.', 'Squeeze at top.'], muscles: ['Biceps'] },
  ...
  { id: 'barbell_skullcrushers', name: 'Barbell Skullcrushers', category: 'Triceps', pattern: 'accessory', impact: 'low', velocity: 'medium', description: 'Triceps extension performed lying down.', instructions: ['Lie on bench.', 'Lower bar to forehead.', 'Extend up.'], tips: ['Keep elbows fixed.', 'Control speed.', 'Full lock out.'], muscles: ['Triceps'] },
